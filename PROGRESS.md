...
The ownership, private repository URL and runtime status below describe the earlier source-only delivery and are superseded by the current sprint above.
